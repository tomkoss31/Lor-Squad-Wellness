-- =============================================================================
-- Rentabilité V6b — uplink rank fallback (2026-05-21)
--
-- Patch RPC `get_users_rentability` et `get_user_rentability_history` pour
-- intégrer le fallback sur `clients.herbalife_uplink_rank` quand
-- `herbalife_uplink_user_id` est NULL.
--
-- Résolution effective du distri_factor :
--   1. uplink_user_id présent → rang du user pointé
--   2. uplink_rank présent → rang en colonne directement
--   3. ni l'un ni l'autre → rang du viewer (cas standard)
-- =============================================================================
...
-- ============================================================================
-- Rebuild get_user_rentability_history avec même 3-tier fallback
-- ============================================================================
