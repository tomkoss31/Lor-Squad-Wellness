...
const DEMO_VIEW: SalleOpsView = {
  ...
  activated: false,
  steps: [
    { n: 1, label: "S'équiper", state: "done" },
    { n: 2, label: "Trouver", state: "done" },
    { n: 3, label: "Inviter", state: "active" },
    { n: 4, label: "Présenter", state: "todo" },
    { n: 5, label: "Relancer", state: "todo" },
    { n: 6, label: "Démarrer ta recrue", state: "locked" },
    { n: 7, label: "Dupliquer", state: "locked" },
  ],
  totalSteps: 7,
  activeStepNumber: 3,
