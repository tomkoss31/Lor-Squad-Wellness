  ...
  return (
    <div className="ls-ops-root" style={fullscreen ? { ...pageWrap, ...fixedOverlay } : pageWrap}>
      <div style={column}>
        ...
        {/* ── Tracker de phases (tableau de marche 90j) ── */}
        ...
        {lesson ? (
          <div style={{ marginTop: 24 }}>
            ...
            <div style={limeCard}>
              ...
              {lesson.faire.script ? (
                <ScriptBox script={lesson.faire.script} />
              ) : null}
        ...
        {/* ── Noaly (tuteur, pré-prompt de la leçon) ── */}
