...
export function CoPiloteV5Page() {
  ...
  return (
    <div className="copilote-v5" style={pageWrapStyle}>
      ...
      {/* ═══ PLAN DU JOUR (refonte chantier 1, 2026-06-13) ═══════════════
          Le nouveau héros : une SEULE file d'actions priorisée (RDV +
          relances propres + inbox) dans le shell premium (360 + pin
          tournant + Noaly). Remplace : hero éditorial, RentabJourney,
          ReferrerStatsCard (« Tes leads » = doublon CRM), StatsRow3,
          DormantClientsWidget, PvActionPlanAlert, Liste100 (→ Outils),
          et la rangée du bas (TodayTimeline = doublon RDV / SideStack =
          carte FLEX retirée). */}
