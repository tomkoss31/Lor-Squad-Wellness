...
export const ACADEMY_SECTIONS: AcademySection[] = [
    ...
    steps: [
      {
        ...
        body: "On va d'abord parler de ton profil. C'est ce qui permet à ton coach de te suivre et à ton équipe de te reconnaître.",
        placement: "center",
      },
      {
        id: "name",
        title: "Ton nom",
        body: "Dans Paramètres, le champ Prénom et nom est éditable. C'est ce que tes clients verront sur les récaps que tu leur envoies.",
        placement: "center",
      },
      {
        id: "herbalife-id",
        title: "Ton ID Herbalife",
        body: "L'identifiant officiel arrive bientôt dans ton profil. Il permettra de relier ton activité à ton lignage.",
        placement: "center",
      },
      {
        id: "sponsor",
        title: "Ton sponsor",
        body: "La personne qui t'a fait découvrir Herbalife. Le champ pour l'indiquer arrive avec l'ID Herbalife.",
        placement: "center",
      },
      {
        id: "coach-referent",
        title: "Ton coach référent",
        body: "C'est le coach qui te suit en interne. On le contactera si tu as besoin d'aide.",
        placement: "center",
        isLast: true,
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Sur ta page Dossiers clients, clique sur un client pour ouvrir sa fiche. Tu y verras son bilan, ses produits, son agenda.",
        placement: "center",
      },
      {
        id: "recommendations",
        ...
        body: "Lor'Squad propose une sélection automatique selon l'objectif et le body scan. Tu ajustes ce qui convient à ton client.",
        manualAdvance: true,
      },
      {
        id: "boosters",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "La page Agenda liste tous tes prochains RDV, classés par date. Tu peux filtrer par type ou par statut.",
        placement: "center",
      },
      {
        id: "follow-up",
  ...
  },
  {
    ...
    steps: [
      ...
      {
        id: "compose",
        title: "Échange avec tes clients",
        body: "Dans Messagerie, tu retrouves toutes les demandes reçues. Tu réponds en un clic, par WhatsApp, SMS ou directement dans l'app.",
        placement: "center",
      },
      {
        id: "filter-clients",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Sur la fiche d'un client, le bouton gold Envoyer l'accès à l'app génère un lien personnel.",
        placement: "center",
      },
      {
        id: "copy-link",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Dans ton navigateur, ouvre le menu et clique sur Installer l'app. Tu auras Lor'Squad comme une app native, avec notifications push.",
        placement: "center",
      },
      {
        id: "pv-gauge",
      ...
      {
        id: "monthly-rhythm",
        title: "Le rythme mensuel",
        body: "Vise ton seuil PV chaque mois. Plus tu es régulier, plus tu progresses dans les paliers Herbalife.",
        placement: "center",
      },
      {
        id: "outro",
