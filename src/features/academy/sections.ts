...
export const ACADEMY_SECTIONS: AcademySection[] = [
  ...
  },
  {
    ...
    shortLabel: "Tour",
    description: "Découvre les 8 onglets principaux de la sidebar et où chaque chose se trouve.",
    estimatedDurationMinutes: 2,
    icon: "🧭",
    steps: [
      {
      ...
      },
      {
        ...
        placement: "bottom",
        title: "3️⃣ Agenda — bilans, suivis, prospects",
      ...
      },
      {
        ...
        placement: "bottom",
        title: "4️⃣ Messagerie — inbox + compose",
      ...
      },
      {
        ...
        placement: "bottom",
        title: "5️⃣ Dossiers clients — ta base",
