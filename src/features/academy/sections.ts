  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Tous tes clients filtrés par lifecycle (Actifs, Pas démarrés, En pause, Arrêtés, Perdus, ⚠ Fragiles). Ouvre une fiche : elle est organisée en **5 onglets** — Vue (+ historique), Mesures (body scan + mensurations), Produits, Actions, Club VIP. C'est ton outil de travail principal au quotidien.",
        manualAdvance: true,
      },
      {
        id: "crm",
        placement: "center",
        title: "3️⃣ CRM — tous tes leads au même endroit",
        body: "Ton pipeline unique : bilans online, Club VIP, recos clients, opportunité — tout arrive ici, à classer (nouveau → contacté → converti). Tu peux **endormir** un lead froid (il sort du flux, zéro relance) ou le **supprimer**. Et les **RDV demandés** par tes prospects s'affichent en haut. 👉 Une porte d'entrée pour transformer tes contacts.",
        manualAdvance: true,
      },
      {
        id: "agenda",
        ...
        body: "Calendrier unique avec filtres par type (clients / prospects / suivis), date (aujourd'hui / semaine / mois) et statut. Badge gold si tu as des prospects programmés aujourd'hui. CTA « + Nouveau RDV » en haut. 💡 Tes prospects peuvent aussi **réserver eux-mêmes** via ton lien public (déclare tes créneaux dans Paramètres > Profil).",
        manualAdvance: true,
      },
      {
        id: "messagerie",
        ...
        placement: "bottom",
        title: "5️⃣ Messagerie — inbox + compose",
        body: "Toutes les demandes reçues depuis l'app cliente atterrissent ici (3 pills : Demandes clients, Demandes produits, Recommandations). Compteur rouge = non lus. CTA gold « + Démarrer une conversation » pour initier l'échange. Push notif temps réel.",
        manualAdvance: true,
      },
      {
        id: "mon-business",
        ...
        placement: "bottom",
        title: "6️⃣ Mon business — ton QG pour piloter",
        body: "Le hub qui regroupe tout ce qui sert à FAIRE tourner ton activité :\n\n🎯 **Prospecter** (ta machine à prospects)\n🔗 **Mes liens** (bilan, VIP, coach…)\n🛒 **Panier** (calcul prix + PV + remise)\n💎 **Rentabilité** (ta marge réelle + PV équipe)\n⚡ **FLEX** (ton moteur 5-3-1)\n💰 **Suivi PV** (ton volume du mois)\n\nUn seul endroit pour piloter — fini de chercher.",
        manualAdvance: true,
        crossRefs: [
      ...
      },
      {
        ...
        placement: "bottom",
        title: "7️⃣ Mon développement — ton hub d'apprentissage",
        body: "TOUT ce qui sert à apprendre, t'entraîner et progresser est ici en 1 seul endroit :\n\n🎓 Academy (parcours guidés)\n📚 Formation distri Herbalife (modules N1/N2/N3)\n🛠 Boîte à outils (scripts, checklists)\n📔 Cahier de bord (21j cobaye + Liste 100 + Journal EBE)\n🎯 Simulateur EBE (entraînement scripté)\n⚡ Comment marche FLEX (tuto pédago)\n🆕 Journal des nouveautés app\n\nTu n'as plus besoin de chercher partout — tout est centralisé.",
        manualAdvance: true,
      },
      {
        id: "noaly",
        placement: "center",
        title: "✨ Noaly — ton assistant IA, partout",
        body: "La bulle ✨ en bas à droite te suit sur toutes les pages. Elle t'aide concrètement :\n\n• **Sur un bilan** → une synthèse + un pitch à dire au client\n• **Dans le CRM** → elle te rédige le message de relance\n• **Au quotidien** → pose-lui une question, demande qui relancer, retrouve un client\n\nElle connaît l'app et t'ouvre la bonne page. Essaie-la dès que tu bloques.",
        manualAdvance: true,
      },
      {
        id: "new-bilan",
      ...
      questions: [
        ...
        },
        {
          ...
          answers: [
            ...
            "Voir le classement des distri du mois",
            "Importer mes contacts depuis Instagram",
          ],
          correctIndex: 0,
          wrongAnswerHints: {
        ...
        {
          id: "q7",
          question: "Tu cherches le Cahier de bord, le Simulateur EBE et le tuto FLEX. Où vas-tu ?",
          answers: [
            "Co-pilote (en scrollant)",
            "Paramètres",
            "Messagerie (onglet Apprentissage)",
            "Mon développement",
          ],
          correctIndex: 3,
          wrongAnswerHints: {
            0: "Co-pilote = pilotage business du jour, pas pour apprendre.",
            1: "Paramètres = ton compte / RGPD / équipe.",
            2: "Pas d'onglet Apprentissage dans la Messagerie.",
          },
          explanation: "Mon développement regroupe TOUT ce qui sert à apprendre : Academy + Formation distri Herbalife + Boîte à outils + Cahier de bord + Simulateur EBE + tuto FLEX + Nouveautés. 1 seul point d'entrée pour ne plus chercher.",
        },
      ],
    },
  },
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body:
          "Clique ce bouton (ou imagine que tu cliques 😄). C'est TON tracker perso : tu testes les produits sur toi pendant 21 jours et tu notes chaque jour ton énergie, ton sommeil, ton poids. Le but : parler de TON vécu, pas d'un argumentaire creux.\n\nTu verras une grille J0 → J21+ avec les jalons J0, J7, J14, J21 mis en avant en doré. Cliquer sur un jour ouvre une modale d'édition (note + énergie 0-10 + sommeil 0-10 + poids).",
      },
      {
        id: "tab-liste",
        target: '[data-tour-id="cahier-tab-liste"]',
      ...
      },
      {
        ...
        placement: "bottom",
        route: "/cahier-de-bord",
        title: "Onglet 3 — Journal EBE perso 📊",
        body:
          "Ton ressenti après chaque RDV bilan. Une entrée est **AUTO-CRÉÉE** à la fin de chaque bilan que tu valides dans Nouveau bilan — avec le prénom du prospect pré-rempli. Tu la complètes plus tard, à froid, avec :\n\n• Ton score perso 0-10 sur la qualité de ton EBE\n• Ce qui a bien marché\n• Ce qu'il faut ajuster pour le prochain\n• L'issue : signed / pending / refused\n• Combien de recos obtenues\n\nLes stats en haut résument ton mois : EBE faits, closings, recos cumulés.",
      },
      {
        id: "rules",
