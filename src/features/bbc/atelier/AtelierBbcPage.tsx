...
const SCREENS: Screen[] = [
  ...
  { k: "scripts", label: "Scripts + Mes liens", source: "props", note: "Entièrement alimenté par les réglages du club → écran complet, rien de vide. Dans l'app, les liens s'ouvrent dans un tiroir (bouton « 🔗 Mes liens » au bout des onglets de Ressources, 15/09) ; ici ils sont posés au-dessus des scripts pour tester les cartes, l'Aperçu et le QR." },
