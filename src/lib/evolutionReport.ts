...
// Logique extraite (2026-04-25) dans src/lib/productRecommendations.ts
// pour être partagée entre la fiche coach et l'onglet Produits de l'app client.
// Ré-export conservé pour la compat des imports existants.
export { generateProductRecommendations }
export type { ProductRecommendation } from './productRecommendations'
