    ...
    return [
      {
        ...
        items: [
          ...
          },
          {
            ...
            name: "Point de départ — Breakfast Club",
            desc: "Le bilan du club : 5 écrans, finit sur RDV au club ou démarrage à distance.",
            url: `${origin}/point-de-depart/${slug}`,
            waIntro: "Salut 👋 Fais ton point de départ en 3 min — tu sauras par quoi commencer, et on voit ensemble la suite 🌱",
          },
          {
            id: "point-de-depart-distance",
            icon: "📡",
            iconBg: "color-mix(in srgb, var(--ls-teal) 16%, transparent)",
            name: "Point de départ — à distance",
            desc: "Même bilan, version zone large : pas de Verdun, tout mène au démarrage à distance. Pour la pub étendue.",
            url: `${origin}/point-de-depart/${slug}?mode=distance`,
            waIntro: "Salut 👋 Fais ton point de départ en 3 min — coaché à distance, où que tu sois. Tu sauras par quoi commencer 🌱",
          },
          {
            id: "business",
            icon: "💼",
