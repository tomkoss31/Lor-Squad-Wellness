...
const initialForm: AssessmentForm = {
  ...
  dinnerExample: "Repas maison peu structure",
  ...
  selectedProgramId: "p-premium",
  nextFollowUp: "2026-04-14",
  comment: "Le client repart avec une solution simple et un prochain rendez-vous pose."
};
