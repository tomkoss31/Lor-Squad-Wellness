...
export const HERBALIFE_PRODUCTS: HerbalifeProduct[] = [
  ...
  // Le SEUL format protéines en sachets scellés du tarif. Il manquait, alors
  // qu'il est la brique du club de petit-déjeuner : reconditionner un pot est
  // interdit (hygiène, quantité), donc un membre qui s'absente avant ses 10
  // visites ne peut repartir qu'avec du scellé. 31,00 € ÷ 7 = 4,43 € le sachet.
  { ref: '441K', name: 'Mélange Vegan pour Boisson Protéinée — 7 sachets', shortName: 'Boisson Protéinée Vegan 7 sachets', category: 'proteines', pv: 13.25, publicPrice: 31.00, vegan: true, objectives: ['prise_de_masse', 'sport_performance', 'bien_etre'], shortBenefit: 'Protéines végétales en dose scellée · À emporter · 100% vegan', notes: '7 sachets — format à emporter, se vend à l\'unité au club' },
  ...
  { ref: '331K', name: 'Boisson Instantanée à base de Thé et d\'Extraits végétaux — Mangue Fruit du Dragon 102g', shortName: 'Thé Concentré Mangue-Dragon Grand Format', category: 'boissons', pv: 34.95, publicPrice: 73.50, vegan: true, objectives: ['energie', 'perte_de_poids', 'bien_etre'], shortBenefit: 'Booster d\'énergie · Thermogenèse · Grand format économique', notes: '102g — Parfum mangue fruit du dragon (SKU 331K) · prix aligné sur le thé 102g, à confirmer' },
