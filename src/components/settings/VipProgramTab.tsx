...
// =============================================================================
//
// Documentation interne pour le coach : c'est quoi le programme Client
// Privilégié Herbalife, comment il fonctionne, comment expliquer aux
// clients, quels paliers existent, FAQ.
//
// Réservé aux roles distri / référent / admin.
// =============================================================================

import { Card } from "../ui/Card";
import { VIP_LEVELS } from "../../features/client-vip/useClientVip";
    ...
    <div className="space-y-4">
      <Card className="space-y-4">
        ...
        >
          ...
          d&apos;offrir à tes clients des remises automatiques et croissantes selon
          le volume cumulé. C&apos;est ton outil n°1 pour fidéliser et activer la
          recommandation. Plus le client recommande, plus sa remise grimpe — sa
          consommation devient quasi gratuite.
        </p>
      </Card>
          ...
          {VIP_LEVELS.map((lv) => (
            <div
              ...
              style={{
                ...
                gap: 14,
                padding: "12px 14px",
                background: lv.level === "none" ? "var(--ls-surface2)" : "var(--ls-surface)",
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  {lv.label}
                  {lv.discount > 0 ? (
                    <span style={{ marginLeft: 8, color: lv.color }}>-{lv.discount} %</span>
                  ) : null}
                </div>
                <div
                  style={{
      ...
      <Card className="space-y-3">
        ...
        >
          ...
          <p style={{ margin: "10px 0 0" }}>
            Elle parraine <strong>sa maman</strong> (125 PV/mois), <strong>une
            collègue</strong> (125 PV/mois) et <strong>une running buddy</strong>{" "}
            (125 PV/mois). Au bout de 1 mois : 125 × 4 = <strong>500 pts cumulés</strong>{" "}
          ...
          <p style={{ margin: "10px 0 0" }}>
            ...
            Sarah. Sur 3 mois : 1 875 pts en cumul glissant → <strong>Ambassadeur
            (-42 %)</strong> 💎
          </p>
        </div>
      </Card>
      ...
      <Card className="space-y-3">
        ...
        >
          <p style={{ margin: 0 }}>
            ...
            tu as systématiquement -15 % sur toutes tes commandes (envoi
            offert dès 40 PV). Et si tu fais découvrir Herbalife à 2-3
            personnes de ton entourage, tu passes Silver (-25 %) puis Gold
            (-35 %). C&apos;est gratuit pour eux d&apos;essayer, ils s&apos;inscrivent avec
            mon ID sponsor, et toi tu cumules les points. La plupart de mes
            clients finissent par payer leurs produits 35-42 % moins cher
            grâce à 4-5 amis. Je t&apos;envoie le lien et l&apos;ID, ça prend 5 min ? »
          </p>
        </div>
        <p
          style={{
        ...
        >
          💡 Tu peux aussi envoyer le template prêt-à-l&apos;emploi depuis le bouton
          « Envoyer un message » sur n&apos;importe quelle fiche client.
        </p>
      </Card>
