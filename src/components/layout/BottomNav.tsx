      ...
      >
        ...
        <NavLink
          ...
          style={{
            ...
            textDecoration: "none",
            minWidth: 48,
            color: isActive(PRIMARY_ITEMS[0].path) ? "var(--ls-gold)" : "var(--ls-text-hint)",
          }}
        >
          <span style={{ display: "inline-flex" }}>{PRIMARY_ITEMS[0].icon}</span>
          <span
            style={{
              fontSize: 10,
              fontFamily: "DM Sans, sans-serif",
              fontWeight: isActive(PRIMARY_ITEMS[0].path) ? 500 : 400,
        ...
        <NavLink
          ...
          style={{
            ...
            textDecoration: "none",
            minWidth: 48,
            color: isActive(PRIMARY_ITEMS[1].path) ? "var(--ls-gold)" : "var(--ls-text-hint)",
            position: "relative",
          }}
        >
          ...
          <span
            style={{
              fontSize: 10,
              fontFamily: "DM Sans, sans-serif",
              fontWeight: isActive(PRIMARY_ITEMS[1].path) ? 500 : 400,
              letterSpacing: "0.05em",
            }}
          >
        ...
        >
          <div
            className="bottom-nav-bilan-btn"
            style={{
              width: 52,
              height: 52,
              borderRadius: "50%",
        ...
        <NavLink
          ...
          style={{
            ...
            textDecoration: "none",
            minWidth: 48,
            color: isActive(PRIMARY_ITEMS[2].path) ? "var(--ls-gold)" : "var(--ls-text-hint)",
          }}
        >
          <span style={{ display: "inline-flex" }}>{PRIMARY_ITEMS[2].icon}</span>
          <span
            style={{
              fontSize: 10,
              fontFamily: "DM Sans, sans-serif",
              fontWeight: isActive(PRIMARY_ITEMS[2].path) ? 500 : 400,
              letterSpacing: "0.05em",
            }}
          >
            {PRIMARY_ITEMS[2].label}
          </span>
        </NavLink>
        ...
        >
          ...
          <span style={{ fontSize: 10, letterSpacing: "0.05em" }}>Plus</span>
        </button>
      </nav>
