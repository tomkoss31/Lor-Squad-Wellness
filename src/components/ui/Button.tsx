...
// - primary (gold) utilise var(--ls-teal) + var(--ls-teal-contrast) via Tailwind arbitrary
  ...
  return (
    <button
      className={cn(
        ...
        variant === "primary" &&
          "bg-[var(--ls-teal)] text-[var(--ls-teal-contrast)] font-bold shadow-[var(--ls-shadow-sm)] hover:brightness-105 hover:shadow-[var(--ls-shadow-md)] focus-visible:ring-2 focus-visible:ring-[rgba(var(--ls-teal-rgb),0.45)]",
        variant === "secondary" &&
