// =============================================================================
// CharterOfficielle — template "Officielle" A4 paper crème classique
//
// Reproduit pixel-perfect `charte-distributeur-premium.html` (validé Thomas).
// Structure A4 + 4 coins art déco + 2 swirls dorés + médaillons + 5 cards
// engagements + signatures + co-fondateurs Mélanie & Thomas.
//
// Refonte 2026-05-03 : extrait de l'ancien CharteDistributeur.tsx pour
// devenir 1 des 3 templates au choix (Officielle / Manifeste / Story).
// Le routeur principal vit maintenant dans CharteDistributeur.tsx.
// =============================================================================
...
export const CharterOfficielle = forwardRef<HTMLDivElement, Props>(
  function CharterOfficielle(
    {
      distributeur,
      cosigner,
      pourquoiText,
